                            ...
                            <div className="footer-links-group">
                                <div className="footer-links">
                                    ...
                                    <ul>
                                        ...
                                        <li><Link to="/about-us">{t('footer.item_3')}</Link></li>
                                        <li><Link to="/contact">{t('footer.item_4')}</Link></li>
                                    </ul>
                                </div>
                                <div className="footer-links">
                                    <h3>{t('footer.item_5')}</h3>
                                    <ul>
                                        <li><Link to="/product/a2-p">{t('footer.item_6')}</Link></li>
                                        <li><Link to="/product/p2-p">{t('footer.item_7')}</Link></li>
                                        <li><Link to="/product/p2-a">{t('footer.item_8')}</Link></li>
                                        <li><Link to="/product/sip-trunking">{t('footer.item_9')}</Link></li>
                                        <li><Link to="/product/virtual-calls">{t('footer.item_10')}</Link></li>
                                    </ul>
                                </div>
                                <div className="footer-links">
